              ...
              if (max - min <= MIN_DYNAMIC_RANGE) {
                ...
                if (verticalRegion > 0 && hortizontalRegion > 0) {
                  ...
                  var averageNeighborBlackPoint =
                    (blackPoints.get(hortizontalRegion, verticalRegion - 1) + 2 * blackPoints.get(hortizontalRegion - 1, verticalRegion) + blackPoints.get(hortizontalRegion - 1, verticalRegion - 1)) /
                    4;
